...
export default function NavMobile(){
    ...
    return(
        <nav className="px-4 flex justify-between w-full items-center h-[60px] sm:hidden pt-4 fixed top-0 z-40">
            <div>
        ...
        <span className="bg-button-arrow size-8 rounded flex items-center justify-center">
